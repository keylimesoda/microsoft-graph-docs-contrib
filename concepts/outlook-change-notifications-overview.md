...
Make sure to [extend](/graph/api/subscription-update) a subscription before it expires. The maximum lifetime for a subscription without Outlook resource data is listed in the [subscription lifetime table](https://learn.microsoft.com/en-us/graph/change-notifications-overview#subscription-lifetime).
